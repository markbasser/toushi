...
async def on_message(message):
    ...
    if message.content == "利食い":
        ...
        await dm.send(f"{message.author.mention}さん　投資情報に参加いただきありがとうございます。BEN COIN🎁10000BEN　🎉/申請後1日位後にウズラウォレットで残高確認【/info BEN】して下さい。ウズラウォレット開設は【/info /help】です。1回のみの🎁です！")
